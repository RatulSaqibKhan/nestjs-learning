...
COPY --chown=node:node ./codes/nestjs_app_modules/tsconfig*.json \
    ./codes/nestjs_app_modules/package*.json \
    ./codes/nestjs_app_modules/yarn.lock* \
    ./
...
COPY --chown=node:node ./codes/nestjs_app_modules/src/ ./src/
